package com.example.fizz.goomapsv21;
...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		currentLocation();
		final ActionBar actionBar = getActionBar();   //Display action bar drop down to select banks/ATMs
	...
	//Browser key AIzaSyCIIa8HuIC1duTLLVRPffQTex0Tw0fVagE
		...
		protected ArrayList<Place> doInBackground(Void... arg0) {
			PlacesService service = new PlacesService(
					"AIzaSyCUUjovK_G1Q-ak0wV5RPTHuzyywDO5iWA");
